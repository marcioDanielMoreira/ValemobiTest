package br.com.valemobiteste.util;
...
public abstract class Utilidades{
	 ...
	 * String para o formato java.util.Date.
	 *
	 * @param String data.
	 ...
	 * @since 18 de out de 2016 22:39:14
	 * @version 1.0
	 */
	...
	/**
	 * Método responsável por converter uma data VÁLIDA do formato
	 * java.util.Date para o formato String.
	 *
	...
	public static final String normalizeString( String texto ) {
		...
		texto = texto.replaceAll( "[^a-zA-Z0-9áàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ][.,!?:...]", "" );
		String padrao = "\\s{2,}";// caso tenha 2 espaços ou mais
